...
use WooVanilla\Api\Customizer\Sidebar;
use WooVanilla\Api\Customizer\Header;
use WooVanilla\Api\Customizer\Footer;
...
class Customizer {
	...
	public function output() {
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'woovanilla_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'woovanilla_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'woovanilla_header_background_color' );
			echo self::css( '.site-header', 'color', 'woovanilla_header_text_color' );
			echo self::css( '.site-header a', 'color', 'woovanilla_header_link_color' );
